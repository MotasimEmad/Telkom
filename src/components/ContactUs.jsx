        ...
        <section id='contact-us' class="text-gray-600 body-font relative text-start">
            ...
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 class="text-gray-700 text-2xl mb-1 font-medium title-font capitalize font-ubuntu">Get in touch with us</h2>
                    ...
                    <div class="relative mb-4">
                        ...
                        <input required value={fullName} onChange={(e) => { setFullName(e.target.value) }} type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    <div class="relative mb-4">
                        <label for="name" class="leading-7 text-sm text-gray-600">Company Name</label>
                        <input required value={companyName} onChange={(e) => { setCompanyName(e.target.value) }} type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    <div class="relative mb-4">
                    ...
                    <div class="relative mb-4">
                        ...
                        <input required value={email} onChange={(e) => { setEmail(e.target.value) }} type="email" id="email" name="email" class="w-full bg-white rounded border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    <div class="relative mb-4">
