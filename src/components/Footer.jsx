const Footer = () => {
    return (
        <footer class="bg-primary pt-20">
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            <a href="#">
                {/* <img class="w-auto h-7" src="https://merakiui.com/images/full-logo.svg" alt="" /> */}
                <h1 class="text-3xl font-semibold text-white lg:text-4xl uppercase">kanta</h1>
            </a>

            <p class="max-w-md mx-auto mt-4 text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            <p class="text-sm text-gray-200">© Copyright 2024. All Rights Reserved.</p>

            <div class="flex mt-3 -mx-2 sm:mt-0">
                <a href="#" class="mx-2 text-sm text-gray-200 transition-colors duration-300" aria-label="Reddit"> Teams </a>

                <a href="#" class="mx-2 text-sm text-gray-200 transition-colors duration-300" aria-label="Reddit"> Privacy </a>

                <a href="#" class="mx-2 text-sm text-gray-200 transition-colors duration-300" aria-label="Reddit"> Cookies </a>
            </div>
        </div>
    </div>
</footer>
