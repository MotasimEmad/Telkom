        ...
        <div className="container mx-auto flex items-center justify-between">
          <div className="hidden md:flex items-center justify-between w-full">
            ...
            <div className="md:flex space-x-6 font-normal text-lg ml-6">
              <Link to="/" className={`cursor-pointer ${location.pathname === '/' && !isContactUsInView ? 'font-semibold text-primary' : ''}`}>
                Home
              </Link>
              <Link to="/services" className={`cursor-pointer ${location.pathname === '/services' ? 'font-semibold text-primary' : ''}`}>
                Services
              </Link>
              <a href="#contact-us" className={`cursor-pointer ${isContactUsInView ? 'font-semibold text-primary' : ''}`}>Contact us</a>
            </div>
          ...
          >
            ...
            <div className="py-8 px-4 mt-6">
              <Link to="/" className={`py-2 block cursor-pointer ${location.pathname === '/' && !isContactUsInView ? 'font-semibold text-primary' : 'text-black'}`}>
                Home
              </Link>
